...
module.exports = async function fetchFinancialData(req, res) {
    try {
        const query1 = 'select payment_id, payment_date,service_charge,job_poster from parttime_srilanka.payment inner join parttime_srilanka.job  where payment.job_id = job.job_id;';
